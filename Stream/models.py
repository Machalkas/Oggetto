...
class Stream(models.Model):
    ...
    streamKey=models.CharField(max_length=250, blank=False, null=False, default="", verbose_name="StreamKey")
    title=models.CharField(max_length=50, blank=False, null=False, default="",  unique=False, verbose_name="Название")
